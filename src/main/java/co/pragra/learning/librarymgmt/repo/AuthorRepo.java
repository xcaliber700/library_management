...
//        //return template.query(sql, new BeanPropertyRowMapper<>(Author.class)); //if row and cols name are same as of database table
...
//        return template.queryForObject(sql, Collections.singletonMap("id", id), new AuthorRowMapper());
//    }
//}
